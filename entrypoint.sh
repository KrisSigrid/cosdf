...
UUID=${UUID:-'2890e66e-db37-4db4-b686-15a19a4e31e7'}
VMESS_WSPATH=${VMESS_WSPATH:-'/2890e66e-db37-4db4-b686-15a19a4e31e7-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/2890e66e-db37-4db4-b686-15a19a4e31e7-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/2890e66e-db37-4db4-b686-15a19a4e31e7-trojan'}
SS_WSPATH=${SS_WSPATH:-'/2890e66e-db37-4db4-b686-15a19a4e31e7-shadowsocks'}
